...
| 10 | Anonymisation (R-COMPLY-2) deletes the `auth.users` row. Confirm no Supabase-managed foreign key elsewhere cascades from it into data this schema depends on. | Verification |
